...
// Ported from KernelSU FloatingBottomBar.kt — GPL-3.0
...
import hook.HyperBackscreen.ui.liquid.InnerShadow
import hook.HyperBackscreen.ui.liquid.innerShadow
import hook.HyperBackscreen.ui.liquid.lens
import hook.HyperBackscreen.ui.liquid.rememberCombinedBackdrop
import hook.HyperBackscreen.ui.liquid.vibrancy
import hook.HyperBackscreen.ui.animation.DampedDragAnimation
import hook.HyperBackscreen.ui.animation.InteractiveHighlight
...
internal fun FloatingBottomBar(
    ...
    val selectedValue = selectedIndex()
    ...
    val dampedDragAnimation = remember(animationScope, tabsCount, density, isLtr) {
        DampedDragAnimation(
            ...
            onDrag = { _, dragAmount ->
                if (tabWidthPx > 0) {
                    if (abs(dragAmount.x) > 0.5f) wasDragged = true
                    updateValue(

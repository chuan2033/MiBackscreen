...
internal fun ConfigPage(
    ...
    CardBlock {
        ...
        SettingsInfoRow(
            label = stringResource(R.string.config_bar_style),
            value = if (floatingNavBar) {
                stringResource(R.string.config_status_floating)
            } else {
                stringResource(R.string.config_status_standard)
            }
        )
        SettingsInfoRow(
            label = stringResource(R.string.config_liquid_glass_status),
            value = if (liquidGlass) statusOn else statusOff
        )
    }
}
